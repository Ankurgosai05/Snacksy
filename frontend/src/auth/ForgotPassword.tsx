    ...
    return (
        <div className="flex items-center justify-center min-h-screen w-full">
            <form onSubmit={handleForgotPassword} className="flex flex-col gap-5 md:p-8 w-full max-w-md rounded-lg mx-4">
                ...
                {loading ? (
                    <Button disabled className="bg-green-600"><Loader2 className="mr-2 h-4 w-4 animate-spin" /> Please wait</Button>
                ) : (
                    <Button className="bg-green-600">Send Reset Link</Button>
                )}
